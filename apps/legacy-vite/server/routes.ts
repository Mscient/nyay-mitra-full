...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.post("/api/legal/chat", authOptional, async (req: AuthRequest, res) => {
    ...
    try {
      ...
      let responseText = completion.choices[0].message.content || "I apologise, I could not generate a response.";

      // Enforce R10: Every AI Output Visible to Users Must Be Labelled
      if (!responseText.includes("Generated by AI")) {
        responseText += "\n\n*Generated by AI — Verify before relying.*";
      }
