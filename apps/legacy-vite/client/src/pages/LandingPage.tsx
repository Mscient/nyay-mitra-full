        ...
        <div style={{
          ...
          {user ? (
            <div style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: 12 }}>
              <button onClick={() => { setMobileMenuOpen(false); navigate("/chat"); }} style={{ width: "100%", padding: "14px", background: "var(--forest)", color: "var(--gold-pale)", border: "none", borderRadius: 12, fontSize: 15, fontWeight: 600 }}>My Consultations</button>
      ...
      <section style={{ padding: "80px 48px", background: "var(--cream)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(240px, 1fr))", gap: 16 }}>
            {[
              { href: "/documents", emoji: "📄", title: "Document Generator", desc: "Draft RTI applications, legal notices, bail petitions, consumer complaints in minutes.", tag: "7 Templates" },
              ...
              { href: "/case-status", emoji: "🔎", title: "Case Status (CNR)", desc: "Enter your CNR number to instantly check case status, next hearing date and full history from eCourts.", tag: "eCourts India" },
